...
--
LoadEffects("boxHideEff.xml")
LoadEffects("swap.xml")
LoadEffects("Axe.xml")
LoadEffects("Lock.xml")
LoadEffects("bomb.xml")
...
--
-- 
Screen:pushLayer(GUI:getLayer("GameGUILayer"))
